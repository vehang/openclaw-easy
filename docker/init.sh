...
def sync():
    ...
    try:
        ...
        if sync_model in ('', 'true', '1', 'yes'):
            ...
            config['agents']['defaults']['workspace'] = env.get('WORKSPACE') or '/root/.openclaw/workspace'
        ...
        sync_rules = [
            ...
            (['FEISHU_APP_ID', 'FEISHU_APP_SECRET'], 'feishu', sync_feishu,
             {'source': 'npm', 'spec': '@openclaw/feishu', 'installPath': '/root/.openclaw/extensions/feishu'}),
            (['DINGTALK_CLIENT_ID', 'DINGTALK_CLIENT_SECRET'], 'dingtalk', sync_dingtalk,
             {'source': 'npm', 'spec': 'https://github.com/soimy/clawdbot-channel-dingtalk.git', 'installPath': '/root/.openclaw/extensions/dingtalk'}),
            (['QQBOT_APP_ID', 'QQBOT_CLIENT_SECRET'], 'qqbot',
             ...
             {'source': 'path', 'sourcePath': '/root/.openclaw/qqbot', 'installPath': '/root/.openclaw/extensions/qqbot'}),
  ...
  e.get('NAPCAT_ADMINS') else {}),
               ...
               {'source': 'path', 'sourcePath': '/root/.openclaw/extensions/napcat', 'installPath':
  '/root/.openclaw/extensions/napcat'}),
            (['WECOM_TOKEN', 'WECOM_ENCODING_AES_KEY'], 'wecom', sync_wecom,
             {'source': 'npm', 'spec': '@sunnoy/wecom', 'installPath': '/root/.openclaw/extensions/wecom'})
        ]
